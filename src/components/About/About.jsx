  ...
  return (
    <section className={`${styles.about} about`}>
      <div className="container">
        <h2 className="title">
          <span className="text-gradient">Обо мне</span>&nbsp;💁🏻‍♂️
        </h2>
        <div className={styles.about__content}>
          ...
          <div className={styles.info}>
            <h3>
              Front-End разработчик <br /> из&nbsp;Москвы, Россия 📍
            </h3>
            <p>
              ...
              путем написания чистого и оптимизированного кода и использования передовых
              инструментов и методов разработки. Я также являюсь командным игроком, который
              преуспевает в сотрудничестве с кросс-функциональными командами для создания выдающихся
              веб-приложений.
            </p>
          </div>
        </div>
